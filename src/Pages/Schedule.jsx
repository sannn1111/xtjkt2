...
const Schedule = () => {
  ...
  if (currentWeek === 1 || currentWeek === 3) {
    piketGroup = [
      ...
      ["Hudha", "Aris", "Bowo", "Ferindo","Maylinda","Rizki","Siska","Gilang"],
      ["Putri", "Natar", "Wahid", "Fadliansyah"],
      ["Cariska", "Pratiwi", "Ridho", "Farji"],
    ];
  } else if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Viktor", "Andre", "Gerinda", "Daniel","Elsa","Hariyadi","Huda","Pratama","Unggun"],
      ["Agus", "Bibit", "Davin", "Lista"],
      ["Hudha", "Aris", "Bowo", "Herlino", "Ferindo","Maylinda","Rizki","Siska","Gilang"],
    ...
    <>
      ...
      <div className="text-white flex flex-col justify-center items-center mt-8 lg:mt-0 overflow-y-hidden">
        ...
        {currentPiketNames && currentPiketNames.length > 0 ? (
          ...
          <p className="opacity-50">Maaf Admin Lagi Puyeng</p>
        )}
      </div>
    </>
  );
